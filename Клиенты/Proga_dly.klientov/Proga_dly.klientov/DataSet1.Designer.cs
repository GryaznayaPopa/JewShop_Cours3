...
namespace Proga_dly.klientov.DataSet1TableAdapters {
...
SELECT Id, Фамилия, Имя, Отчество, [Номер телефона], [Адрес жительства], [Тип товара], [Название товара], Стоимость FROM Клиенты WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Proga_dly.klientov.Properties.Settings.Default.РегисрацияConnectionString;
        }
